...
- [Covers Stats](https://github.com/gdpmat/ps2-covers#Covers_Stats  "Covers Stats")
- [PSCoverDL App](https://github.com/gdpmat/ps2-covers#PSCoverDL)
- [PCSX2 Setup](https://github.com/gdpmat/ps2-covers#pcsx2-setup  "PCSX2 Setup")
...
- Use this URL for default covers
  ```python
  https://raw.githubusercontent.com/gdpmat/ps2-covers/main/covers/default/${serial}.jpg
- or use this one for 3D covers.
  ```python
  https://raw.githubusercontent.com/gdpmat/ps2-covers/main/covers/3d/${serial}.png
